    ...
    try:
        ...
        conn.execute(f"""
            INSERT INTO {TABLE} VALUES
                ('trip_01', '{today} 08:00:00', '{today} 09:00:00'),
                ('trip_02', '{today} 10:00:00', '{today} 11:00:00'),
                ('trip_03', '{today} 12:00:00', '{today} 13:00:00')
        """)
        conn.close()
...
def test_update_real_times_in_duckdb():
    ...
    try:
        ...
        conn.execute(f"""
            INSERT INTO {TABLE} VALUES
                ('trip_01', '{today} 08:00:00', '{today} 09:00:00', NULL, NULL, NULL, NULL, NULL),
                ('trip_02', '{today} 10:00:00', '{today} 11:00:00', NULL, NULL, NULL, NULL, NULL)
        """)
        conn.close()
        ...
        trip_updates = [
            (
                ...
                {"time": f"{today} 09:10:00", "delay": 600},
            ),  # 10 minutes delay
            (
                "trip_02",
...
def test_process_gtfs_rt_data():
    ...
    try:
        ...
        conn.execute(f"""
            INSERT INTO {TABLE} VALUES
                ('trip_01', 'Paris Nord', 'Compiègne', '{today} 08:00:00', '{today} 09:00:00'),
                ('trip_02', 'Compiègne', 'Paris Nord', '{today} 10:00:00', '{today} 11:00:00'),
                ('trip_03', 'Paris Nord', 'Compiègne', '{today} 12:00:00', '{today} 13:00:00')
        """)
        conn.close()
        ...
        trip_id, departure, arrival = trip_updates[0]
